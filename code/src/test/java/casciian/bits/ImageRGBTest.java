...
class ImageRGBTest {
    ...
    void testConstructorWithDimensions() {
        ImageRGB image = new ByteArrayImageRGB(10, 20);
    ...
    void testConstructorCopy() {
        ImageRGB original = new ByteArrayImageRGB(5, 5);
        original.setRGB(2, 3, 0xFF0000);
        
        ImageRGB copy = new ByteArrayImageRGB(original);
    ...
    void testAlphaBlendOver() {
        ImageRGB under = new ByteArrayImageRGB(5, 5);
        ImageRGB over = new ByteArrayImageRGB(5, 5);
    ...
    void testAlphaBlendOverMismatchedDimensions() {
        ImageRGB image1 = new ByteArrayImageRGB(5, 5);
        ImageRGB image2 = new ByteArrayImageRGB(10, 10);
    ...
    void testGetWidthAndHeight() {
        ImageRGB image = new ByteArrayImageRGB(123, 456);
    ...
    void testConstructorCopyLargeImage() {
        ...
        ImageRGB original = new ByteArrayImageRGB(200, 100);
    ...
    void testAlphaBlendOverLargeImage() {
        ...
        ImageRGB under = new ByteArrayImageRGB(150, 100);
        ImageRGB over = new ByteArrayImageRGB(150, 100);
    ...
    void testGetSubimageLargeImage() {
        ...
        ImageRGB image = new ByteArrayImageRGB(200, 100);
    ...
    void testResizeCanvasSmallerLargeImage() {
        ...
        ImageRGB image = new ByteArrayImageRGB(200, 150);
        image.setRGB(0, 0, 0xFF0000);
        image.setRGB(99, 99, 0x00FF00);
        image.setRGB(50, 50, 0x0000FF);
    ...
    void testScaleDimensions() {
        ImageRGB image = new ByteArrayImageRGB(20, 30);
    ...
    void testScaleSameSize() {
        ...
        int w = 20, h = 20;
        ImageRGB image = new ByteArrayImageRGB(w, h);
        for (int y = 0; y < h; y++) {
            for (int x = 0; x < w; x++) {
    ...
    void testScaleNonSquare() {
        ImageRGB image = new ByteArrayImageRGB(20, 10);
    ...
    void testScaleLargeImage() {
        ...
        ImageRGB image = new ByteArrayImageRGB(200, 200);
    ...
    void testScaleChannelIndependence() {
        // Pure red image
        ImageRGB red = new ByteArrayImageRGB(10, 10);
    ...
    void testRotateClockwisePixels() {
        // 3x2 image (W=3, H=2)
        ImageRGB image = new ByteArrayImageRGB(3, 2);
        // Row 0: 1  2  3
        // Row 1: 4  5  6
        image.setRGB(0, 0, 1);
        image.setRGB(1, 0, 2);
    ...
    void testRotateFourTimesIdentity() {
        ImageRGB image = new ByteArrayImageRGB(4, 3);
        for (int y = 0; y < 3; y++) {
            for (int x = 0; x < 4; x++) {
    ...
    void testRotateClockwiseThenCounterClockwise() {
        ImageRGB image = new ByteArrayImageRGB(5, 3);
        for (int y = 0; y < 3; y++) {
            for (int x = 0; x < 5; x++) {
    ...
    void testRotateSquareClockwise() {
        ImageRGB image = new ByteArrayImageRGB(3, 3);
        // 1 2 3
        // 4 5 6
        // 7 8 9
        image.setRGB(0, 0, 1);
